...
extern "C" {
    ...
    pub fn ck_container_request_application_permission_async(
        container_identifier: *const c_char,
        permission_raw: i32,
        callback: AccountStatusCallback,
        refcon: *mut c_void,
    );
    pub fn ck_container_discover_user_identity_async(
        container_identifier: *const c_char,
    ...
    pub fn ck_database_fetch_record_async(
        container_identifier: *const c_char,
        database_scope: i32,
        record_id_json: *const c_char,
        callback: JsonCallback,
    ...
    pub fn ck_database_delete_record_async(
        container_identifier: *const c_char,
        database_scope: i32,
        record_id_json: *const c_char,
        callback: JsonCallback,
    ...
    pub fn ck_database_fetch_query_results_async(
        container_identifier: *const c_char,
        database_scope: i32,
        query_json: *const c_char,
        zone_id_json: *const c_char,
    ...
    pub fn ck_database_fetch_all_record_zones_async(
        container_identifier: *const c_char,
        database_scope: i32,
        callback: JsonCallback,
        refcon: *mut c_void,
    ...
    pub fn ck_database_modify_records_async(
        container_identifier: *const c_char,
        database_scope: i32,
        operation_json: *const c_char,
        callback: JsonCallback,
    ...
    pub fn ck_database_fetch_changes_async(
        container_identifier: *const c_char,
        database_scope: i32,
        operation_json: *const c_char,
        callback: JsonCallback,
